...
class SchoolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'school' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-04-30 06:55:35',
            'modified' => '2017-04-30 06:55:35'
        ],
    ];
}
