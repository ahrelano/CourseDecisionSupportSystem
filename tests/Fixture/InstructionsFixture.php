...
class InstructionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'instruction' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-04-27 20:32:07',
            'modified' => '2017-04-27 20:32:07'
        ],
    ];
}
