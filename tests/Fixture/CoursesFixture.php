...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'course' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'percentage' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'percentage' => 1,
            'created' => '2017-08-28 15:44:37',
            'modified' => '2017-08-28 15:44:37'
        ],
    ];
}
