...
<div class="courses index large-9 medium-8 columns content">
    <h3><?= __('Courses') ?></h3>
    <?= $this->Form->create() ?>
    <?= $this->Form->control('course', ['options'=>$course_options, 'empty'=>'Choose course']) ?>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $course->has('subject') ? $this->Html->link($course->school->school, ['controller' => 'Subjects', 'action' => 'view', $course->school->id]) : '' ?></td>
